...
dataframe.posting_date.dt.days_in_month
...
dataframe[['job_title_short','salary_year_avg','job_country']].sort_values('salary_year_avg')[(dataframe.salary_year_avg > 100000)&(dataframe.job_country == 'Sudan')]